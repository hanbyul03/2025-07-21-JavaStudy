/*
 *  1. 개념 / 정의 => 변수 / 연산자 / 제어문 / 배열 / 메소드 / 클래스 / 객체 / 캡슐화 / 다형성
 ...
 *             오류방지
 *             가독성 향상 
 *      => 저장 크기 byte => bit가 8개 / 0,1만 저장하는 공간
 * 1byte
 *  -----------------
 *   0 1 1 1 1 1 1 1
 *  -----------------
 ...
 *  1) 알파벳 / 한글 사용이 가능 
    ...
    4) 키워드는 사용할 수 없다
       ...
       => 색상이 빨간색
    5) 공백을 사용할 수 없다
      int file name(x) / file_name(o)
      --------------------------------------------
      ** 변수는 의미를 부여 (글자수에는 제한이 없다) 3~7글자가 적당
      *변수는 소문자로 시작한다 (kor, eng, math)
     변수 선언 형식
     데이터형 변수명;
     -----
     정수/실수/문자/논리
